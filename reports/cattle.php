...
//Add title
		...
		$pdf->SetX(95);
		$pdf->Cell(10,8,"MY CATTLE AS AT ".date('d/m/Y H:i')."",0,2,"C");
...
$pdf->Cell(25,8,"Tag",1,0,"C",FALSE);
$pdf->Cell(30,8,"Breed",1,0,"C");
$pdf->Cell(25,8,"Age",1,0,"C",FALSE);
$pdf->Cell(34,8,"B_Price(KShs.)",1,0,"C",FALSE);
$pdf->Cell(34,8,"Buy Date",1,0,"C",FALSE);
...
$pdf->SetFont("","","11");	
	...
	$pdf->Cell(25,8,$tag,1,0,'C',1);
	$pdf->Cell(30,8,$breed,1,0,'C',1);
	$pdf->Cell(25,8,$age,1,0,'C',1);
	$pdf->Cell(34,8,$price,1,0,'C',1);
	$pdf->Cell(34,8,$date,1,0,'C',1);
