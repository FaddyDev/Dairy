...
<?php if(isset($_SESSION["is_logged"])){?>
 <nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <li class="active bg-warning"><a href="diseases.php">Diseases</a></li> 
...
try { 
  ...
  $sql = "SELECT * FROM diseases";// WHERE fmid=?
...
<div class="panel-heading head">Cattle Diseases</div>
<div class="panel-body">
 ...
 <!-- Dummy div just for formatting --><div class="col-md-2"></div>
    <div class="panel panel-primary table-responsive col-md-8" style="margin:auto;">
      <table   class="table table-striped table-hover table-bordered table-condensed" id="dstb">
      ...
      <?php if(isset($_SESSION["is_logged"])){?> <th></th><?php } ?>
		  ...
		  <tr><td><?php echo $ds['signs'];?></td>
		  <td><?php echo $ds['disease'];?></td>
		  <td><?php echo $ds['control'];?></td>
		  <td><?php echo $ds['treatment'];?></td>
		  <td><?php echo $ds['administration'];?></td>
      <td><?php echo $ds['price'];?></td>
      <?php if(isset($_SESSION["is_logged"])){?>
      <td><a class="btn btn-xs btn-info" href="hoOps/editdisease.php?id=<?php echo $ds['id'];?>">
      <?php if($_SESSION["usertype"] == 'fam'){
       if($ds['fmid'] == $_SESSION["uid"]){ echo "Edit";} else{ echo "";} } else{ echo "Fill";}?>
       </a></td>
       <?php } ?>
      </tr>
		  <?php }?>
