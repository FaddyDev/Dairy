...
<?php if(isset($_SESSION["is_logged"])){
 ...
 <nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <li class="active bg-warning"><a href="cattle.php">Cattle</a></li>
...
try { 
  ...
  $sql = "SELECT * FROM cattle WHERE fmid=? AND sold!='yes'";
...
<div class="panel-heading head">Cattle</div>
 ...
 <!-- Dummy div just for formatting --><div class="col-md-2"></div>
    <div class="panel panel-primary table-responsive col-md-8" style="margin:auto;">
      ...
      <?php if(isset($_SESSION["is_logged"])){?> <th></th> <th></th> <?php } ?>
		  ...
		  <tr><td><?php echo $cat['type'];?></td>
		  <td><?php echo $cat['tag'];?></td>
		  <td><?php echo $cat['breed'];?></td>
		  <td><?php echo $cat['age'];?></td>
		  <td><?php echo $cat['b_price'];?></td>
      <?php if(isset($_SESSION["is_logged"])){?>
      <td><a class="btn btn-xs btn-info" href="famOps/editcattle.php?id=<?php echo $cat['cid'];?>">Edit</a></td>
      <td><a class="btn btn-xs btn-warning" href="javascript:confirmDelete(<?php echo $cat['cid'];?>)">Delete</a></td>
       <?php } ?>
      </tr>
		  <?php }?>
		  </tbody>
