...
function confirmDelete(id)
{
 ...
 {
  window.location.href='famOps/deletes.php?del=emp&id='+id;
 }
 else{return false; }
}
</script>
...
<?php if(isset($_SESSION["is_logged"])){
 ...
 <nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <li class="active bg-warning"><a href="employees.php">Employees</a></li>
...
<div class="panel-heading head">Employees</div>
<div class="panel-body">
 ...
 <!-- Dummy div just for formatting --><div class="col-md-2"></div>
    <div class="panel panel-primary table-responsive col-md-8" style="margin:auto;">
      <table   class="table table-striped table-hover table-bordered table-condensed" id="emptb">
      ...
      <?php if(isset($_SESSION["is_logged"])){?>
      <td><a class="btn btn-xs btn-info" href="famOps/editemp.php?id=<?php echo $emp['eid'];?>">Edit</a></td>
      <td><a class="btn btn-xs btn-warning" href="javascript:confirmDelete(<?php echo $emp['eid'];?>)">Delete</a></td>
       <?php } ?>
       </tr>
		  <?php }?>
		  </tbody>
