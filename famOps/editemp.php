 ...
 <nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <li><a href="../employees.php">Employees</a></li>    
       <li class="active bg-warning"><a href="#">Edit Employee</a></li>
...
if(isset($_POST['editemp'])){
   ...
   try {     $sql = "UPDATE employees SET idno=?, role=?, wage=?, name=?, address=?, phone=? WHERE eid=?";
...
<div class="panel panel-primary mydiv">
    <div class="panel-heading">Update Employee Details</div>
    <div class="panel-body">
     <?php foreach ($emps as $emp){?>
 <form action="editemp.php" class="form-group" ooonsubmit="return checkEmp()" method="post">

<p>
<input type="radio" <?php if($emp['role'] == 'Grazer'){ echo "checked='checked'";} ?> name="role" value="Grazer" required>Grazer (<em>Mchungi</em>)
<input type="radio" <?php if($emp['role'] == 'Milker'){ echo "checked='checked'";} ?> name="role" value="Milker"required>Milker
</p> 

<p>
<label>Name</label>
<input type="hidden" name="eid" value="<?php echo $emp['eid'];?>">
<input type="text" name="empname" value="<?php echo $emp['name'];?>" class="form-control add-todo" placeholder="Enter the employee's name"  required />
</p>

<p>
<label>Physical address</label>
<input type="text" name="address" value="<?php echo $emp['address'];?>" class="form-control add-todo" placeholder="Enter the employee's physical address"  required />
</p>

<p>
<label>Phone Number</label>
<input type="text" name="phone" value="<?php echo $emp['phone'];?>" class="form-control add-todo" onKeyPress="return numbersonly(event)" placeholder="Enter the employee's phone number"  required />
</p>

<p>
<label>ID Number</label>
<input type="text" name="idno" value="<?php echo $emp['idno'];?>" class="form-control add-todo" onKeyPress="return numbersonly(event)" placeholder="Enter the employee's ID number"  required />
</p>

<p>
<label>Wage (KShs.0</label>
<input type="text" name="wage" value="<?php echo $emp['wage'];?>" class="form-control add-todo" onKeyPress="return numbersonly(event)" placeholder="Enter the wage to be paid in KShs" />
</p>

<p>
<input type="submit" name="editemp" class="btn btn-primary" style="float: right;" value="Update" id="submit1">
</p>	
