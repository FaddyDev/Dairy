...
if(isset($_POST['editprof'])){
   ...
   try {     $sql = "UPDATE farmers SET Name=?, ID=?, phone=?, username=?, password=? WHERE fmid=?";
...
try { 
  ...
  $sql = "SELECT * FROM farmers WHERE fmid=?";
    $stmt = $conn->prepare($sql);
...
<input type="text" name="uname" value="<?php echo $fm['Name'];?>" class="form-control add-todo" placeholder="Name"  required />
</p>

<p>
<label>ID Number</label>
<input type="text" name="idno" value="<?php echo $fm['ID'];?>" class="form-control add-todo" onKeyPress="return numbersonly(event)" placeholder="ID Number"  required />
</p>

<p>
<label>Phone Number</label>
<input type="text" name="phone" value="<?php echo $fm['phone'];?>" class="form-control add-todo" onKeyPress="return numbersonly(event)" placeholder="Your phone number"  required />
</p>

<p>
<label>Username</label>
<input type="text" name="username" value="<?php echo $fm['username'];?>" class="form-control add-todo" placeholder="Username" />
</p>

<p>
<label>Password</label>
<div class="bg-warning"> There's an existing password, leave the field blank unless you want to change it</div>
<input type="hidden" name="oldpass" value="<?php echo $fm['password'];?>" class="form-control add-todo" placeholder="Password: There's an existing password" />
<input type="text" name="password" class="form-control add-todo" placeholder="Password" />
</p>
