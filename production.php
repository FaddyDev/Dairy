...
function confirmDelete(id)
{
 ...
 {
  window.location.href='famOps/deletes.php?del=prod&id='+id;
 }
 else{return false; }
}
</script>
 ...
 <nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <li><a href="treatment.php">Treatment</a></li>
        <li class="active bg-warning"><a href="production.php">Production</a></li>
...
<div class="panel-heading head">Production</div>
      ...
      <table   class="table table-striped table-hover table-bordered table-condensed" id="cattletb">
		...
		<thead>
          <tr class="text-primary">
			...
			<th>Quantity (ltrs/whlbarws)</th>
            <th>Value (KShs)</th>
            <th>Total Value (KShs)</th>
		  ...
		  <tr><td><?php echo $prod['type'];?></td>
          <?php if($prod['cid'] == 0){ ?>
           <td><?php echo "All"; ?></td>
          <?php }else{ ?>
          <td><?php echo $prod['tag'];?></td> <?php } ?>
		  <td><?php echo $prod['prod_date'];?></td>
		  <td><?php echo $prod['quantity'];?></td>
          <td><?php echo $prod['value'];?></td>
		  <td><?php echo $prod['tot_value'];?></td>
      <?php if(isset($_SESSION["is_logged"])){?>
      <td><a class="btn btn-xs btn-info" href="famOps/editprod.php?cid=<?php echo $prod['cid'];?>&id=<?php echo $prod['pid'];?>">Edit</a></td>
      <td><a class="btn btn-xs btn-warning" href="javascript:confirmDelete(<?php echo $prod['pid'];?>)">Delete</a></td>
       <?php } ?>
      </tr>
		  <?php }?>
		  </tbody>
