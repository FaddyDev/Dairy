  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
       ...
       <?php if(isset($_SESSION["is_logged"])){?>
       <li class="active bg-warning"><a href="farmer.php">Dashboard</a></li>
...
<div class="panel panel-primary">
 <div class="panel panel-heading panel-primary head">Farmer's Dashboard</div>
      <div class="panel-body panel-primary">
        ...
        <div class="col-md-2 panel panel-warning" style="left:0; margin-left:0;">
              ...
              <p> <a class="btn btn-info btn-sm btn-block" href="javascript: loadRegXMLDoc();">Register Cattle</a></p>
              <p> <a class="btn btn-primary btn-sm btn-block" href="javascript: loadAddEmpXMLDoc();">Add Employee</a></p>
              <p> <a class="btn btn-success btn-sm btn-block" href="javascript: loadPricesXMLDoc();">Set Product Prices</a></p>
              <p> <a class="btn btn-warning btn-sm btn-block" data-toggle="modal" data-target="#ModalProd">Record Production</a></p>
              <p> <a class="btn btn-danger btn-sm btn-block" data-toggle="modal" data-target="#ModalTreat">Record Treatment Expenses</a></p>
              <p> <a class="btn btn-default btn-sm btn-block" href="javascript: loadAddFeedsXMLDoc();">Record Feeding Expenses</a></p>              
              <p> <a class="btn btn-info btn-sm btn-block"  href="valuation.php">View Animal Valuation</a></p>
              <p> <a class="btn btn-primary btn-sm btn-block" href="javascript: loadAddDiseaseXMLDoc();">Record Disease Signs</a></p>
          </div>
          <!-- End of ops div -->
         ...
         <div class="col-md-10 panel panel-warning" id="target">
          ...
          <img src="images/favicon.ico" clas="img-rounded" />
           </div>
           <?php include("famOps/addProd.php"); ?>
           <?php include("famOps/addTreat.php"); ?>
         <!--end of target div -->
...
xmlhttp.open("POST","famOps/profile.php",true);
xmlhttp.send();
  }

  //Register Animal
  function loadRegXMLDoc(){
    var xmlhttp;
    if(window.XMLHttpRequest){
      //for IE7+, Firefox, Chrome, Opera, Safari
      xmlhttp = new XMLHttpRequest();
...
xmlhttp.open("POST","famOps/regcattle.php",true);
xmlhttp.send();
  }

   //Prices
  function loadPricesXMLDoc(){
    var xmlhttp;
    if(window.XMLHttpRequest){
      //for IE7+, Firefox, Chrome, Opera, Safari
      xmlhttp = new XMLHttpRequest();
...
xmlhttp.open("POST","famOps/prices.php",true);
xmlhttp.send();
  }

    //Add employee
  function loadAddEmpXMLDoc(){
    var xmlhttp;
    if(window.XMLHttpRequest){
      //for IE7+, Firefox, Chrome, Opera, Safari
      xmlhttp = new XMLHttpRequest();
...
xmlhttp.open("POST","famOps/addEmp.php",true);
xmlhttp.send();
  }

     //Add Feeding Expenses
  function loadAddFeedsXMLDoc(){
    var xmlhttp;
    if(window.XMLHttpRequest){
      //for IE7+, Firefox, Chrome, Opera, Safari
      xmlhttp = new XMLHttpRequest();
...
xmlhttp.open("POST","famOps/addFeeds.php",true);
xmlhttp.send();
  }

     //Add Disease signs 
  function loadAddDiseaseXMLDoc(){
    var xmlhttp;
    if(window.XMLHttpRequest){
      //for IE7+, Firefox, Chrome, Opera, Safari
      xmlhttp = new XMLHttpRequest();
...
xmlhttp.open("POST","famOps/addDisease.php",true);
xmlhttp.send();
  }
</script>
