...
function confirmDelete(id)
{
 ...
 {
  window.location.href='famOps/deletes.php?del=treat&id='+id;
 }
 else{return false; }
}
</script>
...
<?php if(isset($_SESSION["is_logged"])){
 ...
 <nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    ...
    <li class="active bg-warning"><a href="treatment.php">Treatment</a></li>
...
<div class="panel-heading head">Treatment</div>
<div class="panel-body">
 ...
 <!-- Dummy div just for formatting --><div class="col-md-2"></div>
    <div class="panel panel-primary table-responsive col-md-8" style="margin:auto;">
      <table   class="table table-striped table-hover table-bordered table-condensed" id="treatstb">
      ...
      <?php if(isset($_SESSION["is_logged"])){?> <th></th> <th></th> <?php } ?>
		  ...
		  <tr><td><?php echo $treat['type'].': '.$treat['tag'];?></td> 
		  <td><?php echo $treat['disease'];?></td>
		  <td><?php echo $treat['treat_date'];?></td>
      <td><?php echo $treat['charges'];?></td>
		  <td><?php echo $treat['tot_charges'];?></td>
      <?php if(isset($_SESSION["is_logged"])){?>
      <td><a class="btn btn-xs btn-info" href="famOps/edittreat.php?cid=<?php echo $treat['cid'];?>&id=<?php echo $treat['id'];?>">Edit</a></td>
      <td><a class="btn btn-xs btn-warning" href="javascript:confirmDelete(<?php echo $treat['id'];?>)">Delete</a></td>
       <?php } ?>
      </tr>
		  <?php }?>
		  </tbody>
